...
public class ParameterInitialSet:MonoSingleton<ParameterInitialSet>
{
    ...
    public virtual void OnCompleteTotalSetting()
    {
        CompleteTotalSettingEvent?.Invoke();
    }

    public virtual void OnUncompleteTotalSetting()
    {
        UncompleteTotalSettingEvent?.Invoke();
    }
    public virtual void OnCkeckTotalSetting()
    {
        CheckTotalSettingEvent?.Invoke();
    }
    string str1;
    string str2;
    string str3;
